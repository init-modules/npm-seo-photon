...
import {
	...
	type PhotonPageSettingsScope,
} from "@init/photon";

const valueActionOptions: PhotonFieldOption[] = [
	{
		label: "Embedded",
...
const arrayActionOptions: PhotonFieldOption[] = [
	{
		label: "Add",
...
const mediaActionOptions: PhotonFieldOption[] = [
	{
		label: "Force",
		labelKey: "seoPhoton.actions.force.label",
		value: "force",
...
const normalizeOptions = (value: unknown): PhotonFieldOption[] => {
...
const buildSeoSettingsFields = ({
	...
	showSitemap: boolean;
	showLocale: boolean;
	resourceTemplateOptions: PhotonFieldOption[];
	globalTemplateOptions: PhotonFieldOption[];
}): PhotonField[] => {
...
const seoMainFields: PhotonField[] = [
	{
		path: "seo.title",
		label: "Title",
...
const seoExtraFields: PhotonField[] = [
	{
		path: "seo.keywords",
		label: "Keywords",
...
const seoOpenGraphFields: PhotonField[] = [
	{
		path: "seo.ogTitle",
		label: "OG title",
...
const seoTwitterFields: PhotonField[] = [
	{
...
const SeoPhotonPageSettingsPanel = ({
	scope,
	getValue,
	setValue,
	focusField,
}: Parameters<PhotonPageSettingsPanelDefinition["component"]>[0]) => {
	...
	const scopeCopy: Record<PhotonPageSettingsScope, string> = {
...
export const seoPhotonModule: PhotonModule = {
	module: "seo-photon",
	label: "SEO Photon",
...
export const seoPhotonKit: PhotonInstallableKit =
	createPhotonKit({
		key: "seo-photon",
		label: "SEO Photon",
