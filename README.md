# @init-modules/seo-website-builder

SEO page settings kit for the package-first website builder.

## Назначение

@init-modules/seo-website-builder — npm/TypeScript package; Website Builder integration or runtime layer; SEO integration layer; settings/locale layer. Пакет экспортирует TypeScript/React primitives для frontend-части Init/Rx и не должен смешивать backend-интеграции с клиентским runtime.
...
~~~bash
npm install @init-modules/seo-website-builder
~~~
...
Peer dependencies:
- <code>@init-modules/seo ^0.1.0</code>
